      ...
      <article className="px-4 py-3 border-b border-[#2f3336] post-hover transition-colors duration-150 cursor-pointer" data-utrace-target={`feed.post-card.${post.id}`}>
        <div className="flex gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            {/* Body */}
            <p className="mt-1 text-[15px] text-[#e7e9ea] leading-[1.5] whitespace-pre-line">
              {post.body}
            </p>
            ...
            <div className="mt-2.5 flex items-center justify-between max-w-[425px] -ml-2">
              ...
              <button className="group flex items-center gap-1.5">
                <span className="p-2 rounded-full action-comment transition-colors duration-150">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#536471] group-hover:text-[#1d9bf0] transition-colors">
                ...
                <span className="text-[13px] text-[#536471] group-hover:text-[#1d9bf0] transition-colors tabular-nums">{engagement.comments}</span>
              </button>

              {/* Repost */}
              <button className="group flex items-center gap-1.5">
                <span className="p-2 rounded-full action-repost transition-colors duration-150">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#536471] group-hover:text-[#00ba7c] transition-colors">
                ...
                <span className="text-[13px] text-[#536471] group-hover:text-[#00ba7c] transition-colors tabular-nums">{engagement.reposts}</span>
              </button>

              {/* Like */}
              <button className="group flex items-center gap-1.5">
                <span className="p-2 rounded-full action-like transition-colors duration-150">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#536471] group-hover:text-[#f91880] transition-colors">
                    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </span>
                <span className="text-[13px] text-[#536471] group-hover:text-[#f91880] transition-colors tabular-nums">{engagement.likes}</span>
              </button>

              {/* Views */}
              <button className="group flex items-center gap-1.5">
                <span className="p-2 rounded-full action-share transition-colors duration-150">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#536471] group-hover:text-[#1d9bf0] transition-colors">
                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </span>
                <span className="text-[13px] text-[#536471] group-hover:text-[#1d9bf0] transition-colors tabular-nums">{engagement.views}</span>
              </button>

              {/* Bookmark + Share */}
              <div className="flex items-center">
                <button className="p-2 rounded-full action-bookmark transition-colors duration-150">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#536471] hover:text-[#1d9bf0] transition-colors">
