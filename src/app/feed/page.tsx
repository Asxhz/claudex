    ...
    <div className="min-h-screen bg-[#000000] -mt-14">
      ...
      <div className="flex justify-center">
        ...
        <aside className="hidden lg:flex flex-col justify-between w-[275px] h-screen sticky top-0 px-3 py-4 border-r border-[#2f3336]">
          ...
          {currentUser ? (
            <Link href={`/u/${currentUser.handle}`} className="flex items-center gap-3 p-3 rounded-full hover:bg-white/[0.04] transition-colors duration-150">
              ...
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8b8d93" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <main className="w-full max-w-[600px] min-h-screen border-r border-[#2f3336]">
          {/* Feed header */}
          <div className="sticky top-0 z-40 bg-[#000000]/80 backdrop-blur-xl border-b border-[#2f3336]">
            <h1 className="px-4 py-3 text-[20px] font-medium text-[#e7e9ea]">Feed</h1>
            {/* Tab bar */}
            <div className="flex">
              <button className="flex-1 py-3 text-center text-[15px] font-bold text-[#e7e9ea] relative hover:bg-white/[0.04] transition-colors duration-150">
                For you
                <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-16 h-1 bg-[#1d9bf0] rounded-full" />
              </button>
              <button className="flex-1 py-3 text-center text-[15px] text-[#8b8d93] hover:bg-white/[0.04] transition-colors duration-150 font-medium">
                Following
              </button>
            </div>
          </div>
          ...
          <div>
            {posts.length === 0 ? (
              <div className="px-4 py-16 text-center">
                <p className="text-[15px] text-[#8b8d93]">
                  No posts yet. Be the first to run a benchmark.
                </p>
                <Link href="/benchmarks/new" className="inline-block mt-4 bg-[#1d9bf0] hover:bg-[#1a8cd8] text-white font-medium text-[15px] rounded-full py-2.5 px-6 transition-colors duration-150">
                  Run Benchmark
                </Link>
              </div>
            ) : (
        ...
        <aside className="hidden xl:block w-[350px] px-6 py-4 sticky top-0 h-screen overflow-y-auto">
          ...
          <div className="bg-[#0e0f10] rounded-xl border border-white/[0.06] overflow-hidden mb-4">
            ...
            <div className="hover:bg-white/[0.03] transition-colors duration-150 px-4 py-3 cursor-pointer">
              <p className="text-[13px] text-[#536471]">Full Stack</p>
              <p className="text-[15px] font-medium text-[#e7e9ea] mt-0.5">Auth Flow with OAuth2</p>
              <p className="text-[13px] text-[#536471] mt-0.5">512 runs</p>
            </div>
          ...
          {/* Who to follow */}
          <div className="bg-[#0e0f10] rounded-xl border border-white/[0.06] overflow-hidden">
            <h2 className="px-4 pt-3 pb-2 text-[20px] font-medium text-[#e7e9ea]">Who to follow</h2>

            <div className="hover:bg-white/[0.03] transition-colors duration-150 px-4 py-3 flex items-center gap-3">
              <Avatar handle="sarahdev" displayName="Sarah Chen" size="md" />
              <div className="min-w-0 flex-1">
                <p className="text-[15px] font-bold text-[#e7e9ea] truncate">Sarah Chen</p>
                <p className="text-[13px] text-[#8b8d93] truncate">@sarahdev</p>
              </div>
              <button className="bg-[#e7e9ea] text-[#000000] font-bold text-[13px] rounded-full px-4 py-1.5 hover:bg-[#d4d4d8] transition-colors duration-150">
                Follow
              </button>
            </div>
            ...
            <div className="hover:bg-white/[0.03] transition-colors duration-150 px-4 py-3 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[15px] font-bold text-[#e7e9ea] truncate">Alex Rodriguez</p>
                <p className="text-[13px] text-[#8b8d93] truncate">@alexkode</p>
              </div>
              <button className="bg-[#e7e9ea] text-[#000000] font-bold text-[13px] rounded-full px-4 py-1.5 hover:bg-[#d4d4d8] transition-colors duration-150">
                Follow
              </button>
            ...
            <div className="hover:bg-white/[0.03] transition-colors duration-150 px-4 py-3 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[15px] font-bold text-[#e7e9ea] truncate">Maya Johnson</p>
                <p className="text-[13px] text-[#8b8d93] truncate">@mjbuilds</p>
              </div>
              <button className="bg-[#e7e9ea] text-[#000000] font-bold text-[13px] rounded-full px-4 py-1.5 hover:bg-[#d4d4d8] transition-colors duration-150">
                Follow
              </button>
            ...
            <Link href="#" className="block px-4 py-3 text-[15px] text-[#1d9bf0] hover:bg-white/[0.03] transition-colors duration-150">
              Show more
            </Link>
          </div>
